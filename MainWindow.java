...
public class MainWindow extends JFrame {
	...
	public JCheckBox gui_emf;

	/**
	 * Create the frame.
	 */
	public MainWindow() {
		setTitle("EM simulation");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 589, 530);
		...
		gui_brushsize.setBounds(201, 223, 171, 17);
		...
		gui_simspeed.setBounds(10, 223, 171, 17);
		...
		gui_brightness.setBounds(10, 329, 171, 17);
		...
		gui_brushintensity2.setBounds(201, 276, 171, 17);
		panel.add(gui_brushintensity2);
		
		gui_brush = new JComboBox();
		gui_brush.setModel(new DefaultComboBoxModel(new String[] {"Brush: Modify charge density", "Brush: Add Conductor", "Brush: Add EMF source", "Brush: Add Dielectric", "Brush: Add Paramagnet/Diamagnet"}));
		gui_brush.setSelectedIndex(1);
		gui_brush.setBounds(201, 104, 171, 22);
		panel.add(gui_brush);
		...
		gui_view_vec.setBounds(10, 104, 171, 22);
		...
		gui_label_direction.setBounds(211, 308, 161, 14);
		...
		gui_direction.setBounds(201, 329, 171, 17);
		panel.add(gui_direction);
		
		lblVectorBrightness = new JLabel("Vector brightness");
		lblVectorBrightness.setBounds(20, 361, 150, 14);
		...
		gui_brightness_1.setBounds(10, 380, 171, 17);
		...
		gui_simspeed_2.setBounds(10, 276, 171, 17);
		...
		gui_emftype.setBounds(10, 137, 171, 22);
		...
		gui_emf_freq.setBounds(10, 437, 171, 17);
		panel.add(gui_emf_freq);
		
		JLabel lblVectorBrightness_1 = new JLabel("AC Frequency");
		lblVectorBrightness_1.setBounds(20, 412, 116, 14);
		panel.add(lblVectorBrightness_1);
		
		gui_emf = new JCheckBox("EMF ON");
		gui_emf.setSelected(true);
		gui_emf.setBounds(94, 408, 94, 23);
		panel.add(gui_emf);
	}
}
