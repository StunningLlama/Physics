...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		gui_reset.setBounds(10, 15, 171, 23);
		panel.add(gui_reset);

		gui_paused = new JCheckBox("Pause (P)");
		gui_paused.setSelected(false);
		gui_paused.setBounds(10, 49, 101, 23);
		...
		gui_brushsize.setBounds(201, 213, 171, 17);
		...
		gui_simspeed.setBounds(10, 110, 171, 17);
		...
		gui_brightness.setBounds(9, 213, 171, 17);
		...
		gui_parameter1.setBounds(201, 264, 171, 17);
		...
		gui_parameter2.setBounds(201, 314, 171, 17);
		panel.add(gui_parameter2);

		lblVectorBrightness = new JLabel("Vector field brightness");
		lblVectorBrightness.setBounds(20, 242, 150, 14);
		...
		gui_brightness_vec.setBounds(10, 265, 171, 17);
		...
		gui_simspeed_2.setBounds(10, 159, 171, 17);
		...
		gui_material.setBounds(201, 84, 171, 22);
		...
		gui_bc.setBounds(201, 15, 171, 22);
		panel.add(gui_bc);
		addTooltips(gui_bc);
		
		gui_carrierlbl = new JLabel("Charge carrier density");
		gui_carrierlbl.setBounds(20, 342, 150, 14);
