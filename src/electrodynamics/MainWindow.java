...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		gui_brushsize.setBounds(201, 343, 171, 17);
		...
		gui_simspeed.setBounds(10, 343, 171, 17);
		...
		gui_brightness.setBounds(10, 449, 171, 17);
		...
		gui_parameter1.setBounds(201, 396, 171, 17);
		...
		gui_brush.setBounds(201, 173, 171, 22);
		panel.add(gui_brush);
		...
		gui_view.setBounds(10, 173, 171, 22);
		panel.add(gui_view);
		...
		gui_view_vec.setBounds(10, 207, 171, 22);
		...
		gui_parameter2_text.setBounds(211, 428, 161, 14);
		...
		gui_parameter2.setBounds(201, 449, 171, 17);
		panel.add(gui_parameter2);

		lblVectorBrightness = new JLabel("Vector field brightness");
		lblVectorBrightness.setBounds(20, 481, 150, 14);
		...
		gui_brightness_vec.setBounds(10, 504, 171, 17);
		...
		gui_brush_1.setBounds(201, 241, 171, 22);
		...
		gui_simspeed_2.setBounds(10, 396, 171, 17);
		...
		gui_parameter3.setBounds(201, 504, 171, 17);
		panel.add(gui_parameter3);

		gui_parameter3_text = new JLabel("EMF");
		gui_parameter3_text.setBounds(211, 481, 150, 14);
		...
		scrollPane.setBounds(27, 543, 345, 146);
		...
		gui_view_vec_mode.setBounds(10, 241, 171, 22);
		...
		gui_material.setBounds(201, 207, 171, 22);
		...
		gui_bc.setBounds(10, 128, 171, 22);
		panel.add(gui_bc);
		addTooltips(gui_bc);
		...
		gui_adv_settings.setBounds(201, 128, 171, 23);
