...
// Generates random samples from a spatial distribution rho
public class DistributionSampler {
	...
	public double[][] rho;				// Physical density function, unnormalized
	public double rho_tot = 0;			// Total amount
	public double[][] p_dual;			// Probability distribution on dual grid
	public double[][] p_dual_cdf;		// Cumulative probability on dual grid
	...
	public int binarySearch(double p) {
		int M = mx*my;
		int lower = 1;
		int upper = M-1;
		int mid = 0;
	...
	public void generateNsamples(double N, GenFunc f) {
		if (rho_tot <= 0)
			return;
